(function ($) {
    ...
    $('.sazal_navbar li a').on('click', function () {
    ...
    countDownF($('.countDown1'), '2022/04/25');
    countDownF($('.countDown2'), '2022/04/24');
    countDownF($('.countDown3'), '2022/04/26');
